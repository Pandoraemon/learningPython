...
class APITestCase(unittest.TestCase):
    ...
    def test_bad_auth(self):
        ...
        u = User(email='john@gmail.com', password='cat', confirmed=True, role=r)
        db.session.add(u)
        db.session.commit()
    ...
    def test_unconfirmed_account(self):
        ...
        r = Role.query.filter_by(name='User').first()
        self.assertIsNotNone(r)
        u = User(email='john@gmail.com', password='cat', confirmed=False, role=r)
        db.session.add(u)
        db.session.commit()
        ...
        response = self.client.get(
            url_for('api.get_posts'),
            headers=self.get_api_headers('john@gmail.com', password='cat'))
    ...
    def test_posts(self):
        ...
        self.assertTrue(json_response['body_html'] == '<p>body of the blog</p>')
    ...
    def test_users(self):
        ...
        r = Role.query.filter_by(name='User').first()
        self.assertIsNotNone(r)
        u1 = User(email='john@gmail.com', username='john',
                  password='cat', confirmed=True, role=r)
        u2 = User(email='susan@gmail.com', username='susan',
        ...
        response = self.client.get(
            ...
            headers=self.get_api_headers('susan@gmail.com', 'dog'))
        self.assertTrue(response.status_code == 200)
        json_response = json.loads(response.data.decode('utf-8'))
